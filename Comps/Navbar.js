        ...
        {user ? (
          <Dropdown>
            ...
            <Dropdown.Menu>
              ...
              {user.type === "user" && (
                <>
                  <Dropdown.Item href={`/${user.id}/myBookings`}>
                    My Bookings
                  </Dropdown.Item>
                </>
              )}
              {user.type === "owner" && (
                <>
                  <Dropdown.Item href={`/${user.id}/myCourts`}>
                    My Courts
                  </Dropdown.Item>
                  <Dropdown.Item href={`/${user.id}/new`}>
                    Add Court
                  </Dropdown.Item>
                </>
              )}
          ...
          <div className="d-flex">
            ...
            <Link className="btn btn-success m-2" href="/registration/signup">
              Sign up
            </Link>
          </div>
        )}
