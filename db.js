...
db.run("INSERT or IGNORE INTO User (name, phone_number, email, password, type) VALUES ('ammar', '0542463848', 'ammaralmajed7@gmail.com', 'Aa3456', 'owner')");
db.run("INSERT or IGNORE INTO User (name, phone_number, email, password, type) VALUES ('abdulhamid', '0123456789', 'abdulhamid@gmail.com', 'Aa3456', 'user')");
db.run("INSERT or IGNORE INTO User (name, phone_number, email, password, type) VALUES ('ali', '0523456789', 'ali7@gmail.com', 'Aa3456', 'owner')");
